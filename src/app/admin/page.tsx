        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-900">Yelp Import</h3>
                <p className="text-sm text-slate-600">Import dog-friendly places</p>
              </div>
            </div>
            <div className="mt-4">
              <Link
                href="/admin/yelp-import"
                className="inline-flex items-center justify-center rounded-full border border-red-200 px-4 py-2 text-sm font-semibold text-red-700 transition-colors hover:border-red-300 hover:bg-red-50"
              >
                Search Yelp
              </Link>
            </div>
